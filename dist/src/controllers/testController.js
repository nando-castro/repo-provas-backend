...
exports.getAllTestByTeacherOrDiscipline = exports.createTest = void 0;
const testService = __importStar(require("../services/testService"));
function createTest(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const dataTest = res.locals.test;
        yield testService.createTest(dataTest);
        res.sendStatus(201);
    });
}
exports.createTest = createTest;
function getAllTestByTeacherOrDiscipline(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.getAllTestByTeacherOrDiscipline = getAllTestByTeacherOrDiscipline;
